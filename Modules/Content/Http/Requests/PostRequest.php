...
class PostRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'application_type.required' => 'Application type required',
            'application_platform.required' => 'Application platform required',
            'apk_file.required' => 'Apk  file required',
