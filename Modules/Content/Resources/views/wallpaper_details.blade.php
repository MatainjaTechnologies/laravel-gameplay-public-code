...
@section('content')
   <div class="header-title">
        <div class="container d-flex align-items-center">
            <a href="{{ url('wallpaper/more') }}" class="header-title-back">
        ...
        <div class="container">
            ...
            <div class="content-media-box" style="margin-bottom: 20px;">
                <div class="content-media-box-info">
                    <a data-fancybox="gallery" href="images/pic_butterfly.png">
                        @if (file_exists( public_path().'/uploads/wallpaper/'.$details->uuid.'/image/'.$details->image))
                             <img class="img-fluid" src="{{url('uploads/wallpaper/'.$details->uuid.'/image/'.$details->image)}}" alt="Images">
                       @else
                    ...
                    <div class="row">
                        <div class="col-8">
                            <p class="text-left text-truncate">{{$details->name}}</p>
                        </div>
                        <div class="col-4">
            ...
            @if(count($otherWallpaper) >0)
                ...
                <div class="row no-gutters game-list-wrapper">
                           ...
                           @foreach($otherWallpaper as $wallpapers )             
                            <div class="col-4">
                                <div class="game-item">
                                    <a href="{{ url('/wallpaper/details/'.$wallpapers['uuid']) }}">
                                        ...
                                        @endif
                                        <p class="game-item-title text-truncate">{{$wallpapers['name']}}</p>
                                    </a>
                                </div>
                            </div>
                            @endforeach
    ...
    <div class="bottom-nav">
        <div class="container">
            {{-- id="btnPlay" --}}
            <a href="{{url('/wallpaper/download/'.$details->uuid)}}"  class="btn main-download-btn btn-block">Download</a>
        </div>
    </div>
