                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase">Create Wallpaper</span>
                                    </div>
                                    <div class="actions">
                                        ...
                                        <div class="btn btn-transparent dark btn-outline btn-circle btn-sm">
                                            ...
                                            <a href="{{ url('game/admin/list') }}" class="btn btn-xs cus-btn">Wallpaper List</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    ...
                                    @endif
                                    <!-- BEGIN FORM-->
                                    <form action="{{url('/content/admin/app_wallpaper')}}"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                        @csrf
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Wallpaper type
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Wallpaper Rating
                                                </label>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group last">
                                                <label class="control-label col-md-3">Wallpaper Image Upload
                                                <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-9">
                                            ...
                                            <div class="form-group last">
                                                <label class="control-label col-md-3">Wallpaper Download Image <span class="required"> * </span></label>
                                                <div class="col-md-9">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                            <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt="" /> </div>
                                                        ...
                                                        <div>
                                                            <span class="btn default btn-file">
                                                                <span class="fileinput-new"> Select image </span>
                                                                <span class="fileinput-exists"> Change </span>
                                                                <input type="file" name="download_image" accept="image/*"> </span>
                                                            <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput"> Remove </a>
                                                        </div>
                                                    </div>
