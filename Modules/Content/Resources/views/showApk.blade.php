                            ...
                            <div class="portlet light portlet-fit  bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase">List App</span>
                                    </div>
                                    <div class="actions">
                                        ...
                                        <div class="btn btn-transparent dark btn-outline btn-circle btn-sm">
                                            ...
                                            <a href="{{ url('content/admin/app') }}" class="btn btn-xs cus-btn">Add App</a>
                                        </div>
                                    </div>
                                </div>
