                ...
                @if(count($categories)>0)
                    @foreach($categories as $cat)
                        <tr>
                            ...
                            <td>
                                <a href="{{url('/admin/category/'.$cat['uuid'].'/edit')}}" class="btn btn-info btn-sm ">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                                <a href="javascript:void(0);" class="btn btn-danger btn-sm cat_del" data-cat_uuid="{{$cat['uuid']}}"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                    @endforeach    
                @endif
